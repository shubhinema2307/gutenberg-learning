...
var save = wp.element.createElement(
    "svg",
    { "aria-hidden": "true", focusable: "false", "data-prefix": "far", "data-icon": "save", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", "class": "svg-inline--fa fa-save fa-w-14" },
    wp.element.createElement("path", { fill: "currentColor", d: "M433.941 129.941l-83.882-83.882A48 48 0 0 0 316.118 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h352c26.51 0 48-21.49 48-48V163.882a48 48 0 0 0-14.059-33.941zM272 80v80H144V80h128zm122 352H54a6 6 0 0 1-6-6V86a6 6 0 0 1 6-6h42v104c0 13.255 10.745 24 24 24h176c13.255 0 24-10.745 24-24V83.882l78.243 78.243a6 6 0 0 1 1.757 4.243V426a6 6 0 0 1-6 6zM224 232c-48.523 0-88 39.477-88 88s39.477 88 88 88 88-39.477 88-88-39.477-88-88-88zm0 128c-22.056 0-40-17.944-40-40s17.944-40 40-40 40 17.944 40 40-17.944 40-40 40z", "class": "" })
);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__block_container_block_block__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__block_button_block_block__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__block_banner_block_block__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__block_about_block_block__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__block_services_block_block__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__block_features_block_block__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__block_slider_block_block__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__block_storyful_content_block__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__block_storyful_content_block___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__block_storyful_content_block__);
          ...
          wp.element.createElement(
            ...
            wp.element.createElement(
              ...
              wp.element.createElement(SelectControl, {
                ...
                options: [{ label: "Roboto", value: "Roboto" }, { label: "Nautigal", value: "Nautigal" }],
                onChange: function onChange(newval) {
                  return setAttributes({ titleFontFamily: newval });
                }
              }),
              wp.element.createElement(
                'div',
            ...
            wp.element.createElement(
              ...
              wp.element.createElement(SelectControl, {
                ...
                options: [{ label: "Roboto", value: "Roboto" }, { label: "Nautigal", value: "Nautigal" }],
                onChange: function onChange(newval) {
                  return setAttributes({ descFontFamily: newval });
                }
              }),
              wp.element.createElement(
                'div',
          ...
          wp.element.createElement(
            ...
            wp.element.createElement(
              ...
              wp.element.createElement(
                "i",
                {
                  className: " " + ("flex-start" === aboutVerticleAlign ? "active" : ""),
                  onClick: function onClick() {
                    return setAttributes({ aboutVerticleAlign: "flex-start" });
                  }
                },
              ...
              wp.element.createElement(
                "i",
                {
                  className: " " + ("center" === aboutVerticleAlign ? "active" : ""),
                  onClick: function onClick() {
                    return setAttributes({ aboutVerticleAlign: "center" });
                  }
                },
              ...
              wp.element.createElement(
                "i",
                {
                  className: " " + ("flex-end" === aboutVerticleAlign ? "active" : ""),
                  onClick: function onClick() {
                    return setAttributes({ aboutVerticleAlign: "flex-end" });
                  }
                },
                ...
                wp.element.createElement(
                  ...
                  wp.element.createElement(TextControl, {
                    ...
                    onChange: function onChange(aboutTitleFontsize) {
                      return setAttributes({ aboutTitleFontsize: aboutTitleFontsize });
                    }
                  })
                ),
                wp.element.createElement(
                  ...
                  wp.element.createElement(SelectControl, {
                    ...
                    onChange: function onChange(aboutTitleFontWeight) {
                      return setAttributes({ aboutTitleFontWeight: aboutTitleFontWeight });
                    }
                  })
                )
              )
                ...
                wp.element.createElement(
                  ...
                  wp.element.createElement(TextControl, {
                    ...
                    onChange: function onChange(aboutDescFontsize) {
                      return setAttributes({ aboutDescFontsize: aboutDescFontsize });
                    }
                  })
                ),
                wp.element.createElement(
                  ...
                  wp.element.createElement(SelectControl, {
                    ...
                    onChange: function onChange(aboutDescFontWeight) {
                      return setAttributes({ aboutDescFontWeight: aboutDescFontWeight });
                    }
                  })
                )
              )
    ...
    _createClass(edit, [{
        ...
        value: function componentDidMount() {
            ...
            if (slides_array.length > 0) {
                this.OnInitSlides();
                // setAttributes({ slider_save: true})
            } else {
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            var _props$attributes = this.props.attributes,
                ...
                slider_save = _props$attributes.slider_save;
        ...
        value: function onUpdateSliderState() {
            ...
            var _props$attributes2 = this.props.attributes,
                slides_array = _props$attributes2.slides_array,
        ...
        value: function render() {
            ...
            var classes = __WEBPACK_IMPORTED_MODULE_2_classnames___default()(className, "slider-wrap-main");

            var blockTitleStyle = {};

            sliderTitleFontsize && (blockTitleStyle.fontSize = sliderTitleFontsize);
            sliderTitleFontWeight && (blockTitleStyle.fontWeight = sliderTitleFontWeight);
            sliderTitleFontFamily && (blockTitleStyle.fontFamily = sliderTitleFontFamily);

            var slides = slides_array.map(function (data, index) {
                console.log("slides save mode");
                console.log(index);
                console.log(data);
                return wp.element.createElement(
                    "div",
...
registerBlockType("wp-learning/slider-block", {
    ...
    save: function save(props) {
        ...
        var classes = __WEBPACK_IMPORTED_MODULE_2_classnames___default()(className, "row");
