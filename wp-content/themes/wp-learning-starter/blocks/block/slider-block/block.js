...
import { plus, left, right, remove, Remove, Edit, save } from "../custom-icons";
import $ from "jquery";
...
class edit extends Component {
    ...
    componentDidUpdate(prevProps){
        ...
        if(slide_mode !== prevProps.attributes.slide_mode || 
  ...
  render() {
    ...
    const classes = classnames(className, `slider-wrap-main`);
            ...
            <InspectorControls>
                ...
                <SelectControl
                        ...
                        <ToggleControl
                            ...
                            onChange={slide_adaptiveHeight=>setAttributes({slide_adaptiveHeight})}
                        />
                        <RangeControl
                            label={__( "Speed" )}
                            value={slide_speed}
                ...
                <PanelBody title={__("Typography Settings", "wp-learning")} initialOpen={false} >
                    <div className="row-panel">
                        ...
                        <SelectControl
                            ...
                            onChange={(newval) => setAttributes({ sliderTitleFontFamily: newval })}
                        />
                        <div className="row">
                            <div className="col-50">
                                ...
                                onChange={sliderTitleFontsize=>setAttributes({sliderTitleFontsize})}
                                />
                            </div>
                            <div className="col-50">
                                <SelectControl
                                ...
                                onChange={sliderTitleFontWeight=>setAttributes({sliderTitleFontWeight})}
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row-panel">
                        ...
                        <SelectControl
                            ...
                            onChange={(newval) => setAttributes({ sliderDescFontFamily: newval })}
                        />
                        <div className="row">
                        <div className="col-50">
                            <TextControl
                                ...
                                onChange={sliderDescFontsize=>setAttributes({sliderDescFontsize})}
                            />
                        </div>
                        <div className="col-50">
                            <SelectControl
                                ...
                                onChange={sliderDescFontWeight=>setAttributes({sliderDescFontWeight})}
                            />
                        </div>
                        </div>
                    </div>
