...
class edit extends Component {
    ...
    render() {
        ...
        const classes = classnames(className, `banner-content-block`);
                                ...
                                <div className="col-50">
                                    <TextControl
                                        ...
                                        onChange={(bannerTitleFontsize) => 
                                            setAttributes({bannerTitleFontsize})}
                                    />
                                </div>
                                <div className="col-50">
                                    <SelectControl
                                        ...
                                        onChange={(bannerTitleFontWeight) =>
                                            setAttributes({bannerTitleFontWeight})}
                                    />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="col-50">
                                    <TextControl
                                        ...
                                        onChange={(bannerDescFontsize) =>
                                            setAttributes({bannerDescFontsize})}
                                    />
                                </div>
                                <div className="col-50">
                                    <SelectControl
                                        ...
                                        onChange={(bannerDescFontWeight) =>
                                            setAttributes({bannerDescFontWeight})}
                                    />
                                </div>
                            </div>
                        </div>
...
registerBlockType("wp-learning/banner-block", {
    ...
    save: (props) => {
        ...
        return (
            <div id={`wp-learning-${blockId}`}  className={classes} style={blockStyle}>
                <RichText.Content
                    tagName="h1"
                    value={attributes.banner_heading}
                    placeholder={__("Write your heading...")}
